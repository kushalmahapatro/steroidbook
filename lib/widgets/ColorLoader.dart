...
class ColorLoaderPlain extends StatefulWidget {
  final List<Color> colors;
  final Duration duration;

  ColorLoaderPlain({this.colors, this.duration});

  @override
  _ColorLoaderPlainState createState() =>
      _ColorLoaderPlainState(this.colors, this.duration);
}

class _ColorLoaderPlainState extends State<ColorLoaderPlain>
